...
# fairseq-hydra-train --config-dir config/pretrain/ --config-name hubert_base_librispeech.yaml  task.data=/home/hemant/hemant/librispeech/data/manifest/ task.label_dir=/home/hemant/hemant/librispeech/hubert_km_path_data/labels/ task.labels='["km3","km2","km1"]' model.label_rate=50 dataset.max_tokens=1250000 optimization.update_freq=[4] checkpoint.save_dir=/home/rajivratn/hemant/ASR/hubert-cluster/examples/hubert/checkpoints_18_100/ +model.encoder_layers=18
@dataclass
