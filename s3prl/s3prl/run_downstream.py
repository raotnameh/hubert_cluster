...
def get_downstream_args():
    ...
    parser.add_argument('--features-save-path',  default="/data/part4/superb/s3prl/s3prl/result/features/", type=str)
    ...
    parser.add_argument('-a', '--auto_resume', action='store_true', default=True,help='Auto-resume if the expdir contains checkpoints')
    ...
    path = args.features_save_path
    if args.expdir is None:
        args.expdir = f'/data/part4/superb/s3prl/s3prl/result/downstream/{args.expname}'
    args.a = True
    if args.auto_resume:
